...
const WorkshopsGrid = ({ workshops, onEnroll }) => {
  if (workshops.length === 0) {
    return (
      <div className="py-24 text-center border border-dashed border-slate-200 dark:border-white/10 rounded-sm bg-slate-50 dark:bg-slate-900/20 transition-colors">
