...
export default function AgendaPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-600 selection:text-white transition-colors duration-300">
      ...
      {/* CTA SECTION */}
      <section className="relative z-10 dark:bg-gradient-to-b from-slate-950 to-[#0b1120] bg-gradient-to-b from-white to-slate-200 dark:bg-white/5 py-24 transition-colors duration-300 text-center">
